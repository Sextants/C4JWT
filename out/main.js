...
function Test() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        console.log(JSON.stringify(VerifyToken, null, 4));
        yield Sleep(60000);
        let Token = yield CurJWT.refreshJWT(CurToken);
        console.log("----------Refresh Result----------");
        console.log(JSON.stringify(C4JWT_2.decodeToken(Token), null, 4));
        yield CurJWT.revokeJWT(Token);
        VerifyToken = yield CurJWT.verifyJWT(Token);
        console.log("----------Verify Result----------");
        console.log(JSON.stringify(VerifyToken, null, 4));
    });
}
